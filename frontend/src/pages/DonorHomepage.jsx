    ...
    switch (sortBy) {
      ...
      case "progress":
        filtered = sorted.sort((a, b) => {
          ...
          return (
            Math.round((b.supportTypes?.monetary?.currentAmount / bT) * 100) -
      ...
      <div className="donor-header">
        ...
        <div className="donor-header-actions">
          <button
            ...
            onClick={() => navigate("/donor/asean")}
          >
            ASEAN
          </button>
          <button
            className="bookmarks-nav-btn"
            onClick={() => navigate("/donor/partnerships")}
          >
            PARTNERSHIPS
          </button>
          <button
          ...
          <button className="switch-account-btn" onClick={handleLogout}>
            LOGOUT
          </button>
        </div>
      </div>
                      ...
                      {campaign.orgIsVerified && (
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            navigate(
                              `/organization/${campaign.orgId}/verification`,
                            );
                          }}
                        >
                          Verified NGO
