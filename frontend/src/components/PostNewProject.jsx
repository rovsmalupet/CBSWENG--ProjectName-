...
export default function PostNewProject({ onProjectCreated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (supportTypes.inKind) {
      for (const item of inKindItems) {
        if (
          ...
          setErrorMsg(
            "All in-kind items must have a name, positive quantity, unit, and positive price per unit.",
          );
          setStatus("error");
          return;
        }
    ...
    try {
      ...
      await apiFetch(getApiUrl("/posts"), {
        method: "POST",
  ...
  return (
    <div className="postProjectPage">
      <div className="postProjectCard">
        ...
        {status === "error" && (
          <div className="postProjectAlertError">Warning: {errorMsg}</div>
        )}
        ...
        <form onSubmit={handleSubmit} className="postProjectForm">
          ...
          <div className="postProjectCol">
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <button
                type="button"
                className="postProjectCancelBtn"
