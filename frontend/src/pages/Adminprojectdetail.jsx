...
export default function AdminProjectDetail() {
  ...
  const isUnapprovedOrEdited = ["Pending", "Edited", "Unapproved"].includes(
              ...
              <ul className="apd-audit-list">
                {auditLogs.map((log) => (
                  <li key={log.id} className="apd-audit-item">
                    <span className="apd-audit-action">
                      {displayAction(log.action)}
                    </span>
                    {" by "}
                    <span className="apd-audit-admin">
                      {log.admin.firstName} {log.admin.lastName}
                    </span>
                    <span className="apd-audit-date">
                      {" "}
